<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid float-end">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav">
                <li class="p-4" > <a href="https://avemperu.com/es/avem-peru" target="_blank"><img src="http://localhost/sist-quero/src/asssets/img/avem.png" class="img-fluid" height="50px" width="80px" /></a></li>
            </ul>
